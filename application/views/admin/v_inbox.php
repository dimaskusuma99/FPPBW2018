            ...
            <div class="box-body">
              <table id="example1" class="table table-striped" style="font-size:12px;">
				...
				<?php
                    ...
                    ?>
                <tr>
                  <td><?php echo $user->inbox_tanggal ?></td>
                  <td><?php echo $user->inbox_nama ?></td>
                  <td><?php echo $user->inbox_email ?></td>
                  <td><?php echo $user->inbox_kontak ?></td>
                  <td><?php echo $user->inbox_pesan ?></td>
                  <td style="text-align:right;">
                        <a class="btn" data-toggle="modal" data-target="#ModalHapus<?php echo $user->inbox_id;?>"><span class="fa fa-trash"></span></a>
                  </td>
                </tr>
				<?php endforeach;?>
...
<?php foreach ($data->result_array() as $user) :
            ...
            $inbox_nama=$user['inbox_nama'];
            $inbox_email=$user['inbox_email'];
            $inbox_msg=$user['inbox_pesan'];
