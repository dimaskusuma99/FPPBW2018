      ...
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          <div class="info-box bg-red">
            ...
            <?php
                    $query=$this->db->query("SELECT * FROM tbl_tulisan WHERE DATE_FORMAT(tulisan_tanggal,'%m%y')=DATE_FORMAT(DATE_SUB(CURDATE(), INTERVAL 1 MONTH),'%m%y')");
                    $jml=$query->num_rows();
              ?>
            <div class="info-box-content">
              <span class="info-box-text">Post Berita Bulan Lalu</span>
          ...
          <div class="info-box bg-aqua">
            <span class="info-box-icon"><i class="fa fa-newspaper-o"></i></span>
             <?php
                    $query=$this->db->query("SELECT * FROM tbl_tulisan WHERE DATE_FORMAT(tulisan_tanggal,'%m%y')=DATE_FORMAT(CURDATE(),'%m%y')");
                    $jml=$query->num_rows();
              ?>
            <div class="info-box-content">
              <span class="info-box-text">Post Berita Bulan Ini</span>
              <span class="info-box-number"><?php echo number_format($jml);?></span>
